...
| X4 | Dump local ollama: llama.cpp+HF everywhere (llm-models canonical, embed worker, /pull, scout rewrite) | hard | **COMPLETE 2026-07-05** — daemons disabled, stores deleted (148GB reclaimed), all services green post-deletion | X1, M5.1 | rollback: re-enable ollama units until stores deleted |
