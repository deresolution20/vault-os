...
| X4 | Dump local ollama: llama.cpp+HF everywhere (llm-models canonical, embed worker, /pull, scout rewrite) | hard | **phase 1 done 2026-07-05** — workers+RAG+catalog off ollama; new agentic models downloading; decommission staged for Brice sudo | X1, M5.1 | rollback: re-enable ollama units until stores deleted |
